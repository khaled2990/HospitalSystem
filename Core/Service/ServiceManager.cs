...
namespace Service
{
    public class ServiceManager(IDoctorRepository _doctorRepository, IMapper _mapper, UserManager<ApplicationUser> userManager,IConfiguration configuration, IPatientRepository patientRepository) : IServiceMamager
    {
